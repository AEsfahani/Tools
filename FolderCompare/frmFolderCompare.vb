...
#Region "Methods"
    ...
    Private Sub CompareSourceFiles()
        ...
        Try
            base = txtBaseFile.Text
            r = System.AppDomain.CurrentDomain.BaseDirectory()
            If base.Substring(0, 3) = "..." Then
                base = base.Replace("...\", r)
            End If
            ' MsgBox(base)
            ' MsgBox(base)
            Dim fiBase As New FileInfo(base)
...
#Region "Events"
    ...
    Private Sub frmMas500SupportTools_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not String.IsNullOrEmpty(My.Settings.DefaultFolderToCompare) Then
            ...
            End If
        Else
            txtComparisonFolderPath.Text = MAS90path
        End If
...
#End Region
    ...
    Private Sub AboutSage100FolderCompareToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AboutSage100FolderCompareToolStripMenuItem.Click
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        'Me.TabControl1.TabPages.Item("tabInstalcompare").Focus()
        '    Me.TabControl1.TabPages(1).
        TabControl1.SelectedTab = tabInstallCompare
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        s = CStr(ComboBox1.SelectedItem)
        txtBaseFile.Text = "...\DataSets\XMLSources\" & s & ".xml"
    End Sub

    Private Sub btnCleargrid_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCleargrid.Click
        'grdMgr.ClearGrid(dgvComparison)
        dgvComparison.DataSource = Nothing
        grdMgr.FormatGrid(dgvComparison)
