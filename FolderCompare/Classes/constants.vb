...
Public NotInheritable Class Constants
    ...
    Public Const kDestinationFileLocationIncorrect As String = "The destination file location is incorrect. Please choose a valid destination file."

    'Allow the caller to edit up to two parameters of the file
    Public Const kDefaultFileComparisonFileName As String = "Sage100cmp{0}{1}"
    ...
    Public Const kEmailingSupport As String = "Emailing Sage 100 Customer Support"
    ...
    Public Const CurrentVersion As String = "1.0.0.7"
    Public Const CurrentVersionShort As String = "4.50"
    Public Const ProductName As String = "Sage 100 Folder Compare"
    Public Const ProductFullName As String = "Sage 100 Folder Compare"
    Public Const ProductShortName As String = "Sage 100 Folder Compare"
    ...
    Public Const CompanyName As String = "Sage"
    Public Const Copyright As String = "Copyright(c) 1995-2013 " & CompanyName
    Public Const CompanyMediumName As String = "Sage"
    Public Const CompanyShortName As String = "Sage"
    Public Const DesktopName As String = ProductShortName & " Desktop"
    Public Const DefaultSysDSNName As String = "MAS 90"
    Public Const DefaultAppDSNName As String = "MAS 90"
    ...
    '********************************************************************
    ' DataType - Defines the data type in MAS 90 data dictionary tables
    '********************************************************************
