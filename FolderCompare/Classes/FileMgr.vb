    ...
    Private Sub ProcessDirectory(ByVal sourceDir As String, _
        ...
        Try
            ...
            For Each fi As FileInfo In di.GetFiles()
                ...
                Dim a As String
                Dim m As String = ""
                Dim k As String = "Sorry the path entered does not include MAS90 folder"

                m = fi.FullName.ToString().Split(CChar("MAS90"))(1)

                '  MsgBox("Sorry the path entered does not include MAS90 folder")
                


                m = "..\M" & m
                ' MsgBox(m)
                a = UCase(fi.FullName.ToString())
                i = InStrRev(a, "MAS90")
                ...
                ' MsgBox("4")
                Try
                    m = a.Substring(i - 1, a.Length - i + 1)
                Catch ex As Exception
                    'ex.Message = "Sorry the path entered does not include MAS90 folder"
                    ' MsgBox("Sorry the path entered does not include MAS90 folder")
                    Throw New Exception("Sorry the path entered does not include MAS90 folder")
                End Try
